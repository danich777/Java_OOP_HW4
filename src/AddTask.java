...
public class AddTask {
    ...
    public static void addTask() {
        ...
        TaskList.add(new Task(LocalDate.now(), deadline, author, description, taskPriority));
        Task.print(new Task(LocalDate.now(), deadline, author, description, taskPriority));
    }
